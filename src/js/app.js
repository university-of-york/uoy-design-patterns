/*
// load in our Rollbar code.
// Note, this will be updated once we move to webpack/node
var _environment = location.href.indexOf('localhost') > 0 ? 'staging' : 'production';
var _rollbarConfig = {
    accessToken: 'ea1da3f5833b4d8c8c423283a06c4cdb',
...
requirejs.config({
  ...
  paths: {
    ...
    firebaseApp: '//www.gstatic.com/firebasejs/5.3.0/firebase' // TODO: replace this with separate modules
  }
});
