module.exports = function (grunt) {
  ...
  grunt.registerTask('build', ['clean:build', 'makedocs:build', 'compass:build', 'autoprefixer:build', 'clean:precssmin', 'modernizr', 'cssmin', 'newer:imagemin', 'requirejs', 'jshint:dev', 'clean:postbuild']);
